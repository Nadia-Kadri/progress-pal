    ...
    <Paper elevation={3} sx={{ height: '500px' }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-evenly', alignItems: 'center', p: '5px' }}>
        ...
        <Box sx={{ height: '364px', overflow: 'auto', px: 3 }}>
          {habits.length === 0 ? (
            <Typography variant='body2' align='center'>It look&#39;s like you dont have any habits yet. Start tracking your progress by creating a new habit. Click the button below to get started!</Typography>
          ) : (
            habits.map(habit => {
